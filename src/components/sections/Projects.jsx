      ...
      <div className="space-y-20">
        {PROJECTS.map((project, index) => (
          <motion.div 
            ...
            className="group border-t border-line pt-10 grid md:grid-cols-12 gap-8"
          >
            {/* 01 / Project ID */}
            <div className="md:col-span-2 text-text-muted font-mono text-xl">
              0{index + 1}
            </div>
            ...
            <div className="md:col-span-10">
              ...
              <div className="flex gap-3 mt-8">
                {project.tech.map((t) => (
                  <span key={t} className="px-3 py-1 text-sm border border-line rounded-full text-text-muted">
                    {t}
                  </span>
                ))}
              </div>
